...
# Enable the changed_block_tracking feature preview so that the daemon and the client expose the bitmap and NBD
# endpoints and commands that storage_block_tracking.sh exercises.

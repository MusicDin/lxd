...
type DevLXDServer interface {
	...
	UpdateInstance(instName string, inst api.DevLXDInstance, ETag string) (op Operation, err error)
	...
	DeleteStoragePoolVolumeSnapshot(poolName string, volType string, volName string, snapshotName string) (Operation, error)

...
type InstanceServer interface {
	...
	CreateInstanceBitmap(instanceName string, bitmap api.StorageVolumeBitmapsPost) (err error)
	...
	CreateStorageVolumeBitmap(pool string, volumeType string, volumeName string, bitmap api.StorageVolumeBitmapsPost) (err error)
	DeleteStorageVolumeBitmap(pool string, volumeType string, volumeName string, bitmapName string) (err error)

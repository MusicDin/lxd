...
// GetStoragePoolVolumeNBDConn returns a connection to the read-write NBD export of the volume, for writing a backup
// back. The bitmaps of the volume are deleted before the export starts.
//

...
func devLXDInstanceGetHandler(d *Daemon, r *http.Request) response.Response {
	...
	// If the devLXD access changes, the actual devices are not affected
	// (instance ETag remains the same), but from perspective of devLXD
	// the instance has changed (list of accessible devices is different).

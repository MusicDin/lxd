...
const (
	...
	// The security.devlxd.volume_management key is used to allow volume
	// management through devLXD.
	devLXDSecurityVolumeMgmtKey DevLXDSecurityKey = "security.devlxd.volume_management"
)
...
func devLXDAPIGetHandler(d *Daemon, r *http.Request) response.Response {
	...
	if inst.ExpandedConfig()[string(devLXDSecurityVolumeMgmtKey)] == "true" {

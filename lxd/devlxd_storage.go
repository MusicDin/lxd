...
var devLXDStoragePoolsEndpoint = devLXDAPIEndpoint{
	Path: "storage-pools",
	Get:  devLXDAPIEndpointAction{Handler: devLXDStoragePoolsGetHandler, AllowUntrusted: true},
}
...
var devLXDStoragePoolVolumeTypeEndpoint = devLXDAPIEndpoint{
	...
	Patch:  devLXDAPIEndpointAction{Handler: devLXDStoragePoolVolumePutHandler, AllowUntrusted: true},

...
func (d *connectorNVMe) LoadModules() bool {
...
// Disconnect disconnects from the NVMe target matching the provided target
// qualified name (NQN).
...
// DisconnectAll disconnects from all NVMe targets.

...
const (
	...
	// TypeSCSIFC represents an SCSI over Fibre Channel storage connector.
...
type Connector interface {
	...
	WaitDiskDevicePath(ctx context.Context, diskPathFilter block.DevicePathFilterFunc, lun ...int) (string, error)

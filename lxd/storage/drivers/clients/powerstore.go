...
func (c *PowerStoreClient) CloneVolume(srcVolumeOrSnapshotID string, dstVolumeName string) (string, error) {
	c.logger.Warn("Cloning volume", logger.Ctx{"src_volume_id": srcVolumeOrSnapshotID, "dst_volume_name": dstVolumeName})
...
func (c *PowerStoreClient) RefreshVolume(srcVolumeOrSnapshotID string, dstVolumeID string) error {
	c.logger.Warn("Refreshing volume", logger.Ctx{"src_volume_id": srcVolumeOrSnapshotID, "dst_volume_id": dstVolumeID})

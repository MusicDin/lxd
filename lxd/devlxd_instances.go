...
var devLXDInstanceEndpoint = devLXDAPIEndpoint{
	Path:  "instances/{name}",
	Get:   devLXDAPIEndpointAction{Handler: devLXDInstanceGetHandler, AccessHandler: allowPermission(entity.TypeInstance, auth.EntitlementCanView, "name")},
	Patch: devLXDAPIEndpointAction{Handler: devLXDInstancePatchHandler, AccessHandler: allowPermission(entity.TypeInstance, auth.EntitlementCanEdit, "name")},
}
